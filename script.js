...
form.addEventListener("submit", function (event) {
  ...
  if (pseudo.value.length < 1) {
    ...
    let errr = document.createElement("li");
    errr.innerText = "Le champ prénom doit être rempli";

    errorList.appendChild(errr);
  } else {
  ...
  if (email.value == "") {
    ...
    let errr = document.createElement("li");
    errr.innerText = "Le champ email ne peut pas être vide";
  ...
  if (axe.value == "") {
    ...
    let errr = document.createElement("li");
    error.innerText = "Le champ axe doit être choisis";
